...
class Xcrud_config
{
    ...
    public static $dbuser = 'crud'; // Your database username
    public static $dbpass = 'xCrud'; // // Your database password
    public static $dbhost = 'mysql'; // Your database host, 'localhost' is default.
